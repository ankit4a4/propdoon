                ...
                >
                    ...
                    <motion.h2 variants={fadeIn} className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                        Why <span className="relative">
                            <span className="text-[#E62F35]">Choose PropDoon</span>
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="h-full p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden">
                                {/* Icon */}
                                <div className="relative z-10 mb-6 w-16 h-16 rounded-2xl bg-[#D5F0FB] text-[#64C0ED] flex items-center justify-center group-hover:bg-[#64C0ED] group-hover:text-white transition-all duration-300">
                                    <motion.div
                                ...
                                <div className="relative z-10">
                                    <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[#64C0ED] transition-colors duration-300">
                                        {feature.title}
                                    </h3>
                                    <p className="text-gray-600 mb-4">{feature.description}</p>
                                    <span className="inline-block px-3 py-1 bg-[#64C0ED]/10 text-[#64C0ED] text-sm font-medium rounded-full">
                                        {feature.stat}
                                    </span>
                                </div>

                                {/* Hover background */}
                                <div className="absolute inset-0 bg-gradient-to-br from-[#64C0ED]/5 to-[#E62F35]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                            </div>
                        </motion.div>
                    ))}
                </motion.div>
